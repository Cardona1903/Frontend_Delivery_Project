...
import { deleteInfringement, getInfringements, updateInfringement } from "../../services/InfringementService";
...
const ListInfringements = () => {
  ...
  const handleEdit = (id: number) => {
    const infringementToEdit = data.find(item => item.id === id);
      ...
      <div className="flex flex-col gap-9">
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
            <h3 className="font-medium text-black dark:text-white">Listado de Infracciones</h3>
          </div>
