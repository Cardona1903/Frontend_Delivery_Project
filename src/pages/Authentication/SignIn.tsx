            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSignIn}>
                ...
                <button
                  ...
                  disabled={loading}
                  className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50 disabled:opacity-70"
                >
                  <span>
                    <svg
                      width="20"
                  ...
                  {loading ? 'Procesando...' : 'Sign in with Google'}
                </button>
